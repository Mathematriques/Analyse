...
\begin{exemple}
	...
	\begin{itemise}
		...
		\item la topologie discrète $\mathfrak{P}(E)$.
...
\begin{demonstration}
	...
	\begin{itemise}
		\item Soit $(O_i)_{i\in I}$ une famille de $\mathscr{T}$ et $O=\bigcup_{i\in I}O_i$.
		S'ils sont tous vides alors $O=\vide\in\mathscr{T}$.
		Sinon il existe un $O_j\in\mathscr{T}$ non vide, ce qui implique $\complement O_j$ est fini.
		De plus $\complement O=\bigcap_{i\in I}\complement O_i\subset\complement O_j$ fini donc $\complement O$ est fini donc $O\in\mathscr{T}$.
		\item Soit $(O_i)_{1\infegal i\infegal n}$ une famille finie de $\mathscr{T}$ et $O=\bigcap_{i=1}^nO_i$.
		Si un des $O_i$ est vide alors $O=\vide\in\mathscr{T}$.
		Sinon chaque $O_i\in\mathscr{T}$ est non vide, ce qui implique $\complement O_i$ est fini.
		Donc $\complement O=\bigcup_{i=1}^n\complement O_i$ est une union finie d'ensemble finis donc est finie donc $O\in\mathscr{T}$.
	\end{itemise}
\end{demonstration}
...
% \begin{proposition}
% 	La topologie classique sur $\R$ est $\ens{]a, b[\subset\R}{a<b}$.
% \end{proposition}
...
\equivalence{Par double implication.}{
	...
	Soient $F, G\in\complement\mathscr{T}$ disjoints.
...
\equivalence{Par double implication.}{
	Soit $\mathfrak{B}$ une base de filtre $\mathfrak{F}$.
		\begin{itemise}
	...
	Soit $\mathfrak{B}$ vérifiant les propriétés.
		\begin{itemise}
...
\equivalence{Par double implication.}{
	Par l'absurde, soit $\mathfrak{F}$ un filtre convergent vers $x$ et $y$ distincts.
...
\equivalence{Par double implication.}{
	La trace $\mathfrak{B}$ des voisinages sur $X$ forme une base de filtre car :
		\begin{itemise}
...
\equivalence{Par double implication.}{
	Soit $\mathfrak{F}$ convergent en $x$ et $W\in\mathfrak{W}(f(x))$.
...
\equivalence{Par double implication.}{
	Soit $\mathfrak{U}$ un ultrafiltre et $X\in\mathfrak{P}(E)$ tel que $X\notin\mathfrak{U}$.
	...
	Par l'absurde, supposons que $\mathfrak{U}$ n'est pas un ultrafiltre.
...
\equivalence{Par double implication.}{
	Soit $\mathfrak{B}$ une base de $\mathscr{U}$.
	\begin{itemise}
...
\equivalence{Par double implication.}{
	...
	Soit $\mathscr{U}$ vérifiant la propriété, $\mathscr{T}$ la topologie engendrée par $\mathscr{U}$, $F\in\complement\mathscr{T}$ et $x\notin F$.
...
\equivalence{Par double implication.}{
	Soit $\mathfrak{F}$ un filtre sur $E$ quasi-compact.
...
\begin{proposition}
	...
	\iff
	\forall\epsilon>0, \exists N\in\N, \forall n\supegal N, d(x_n, x)<\epsilon
	$$
\end{proposition}
...
\equivalence{
	...
	Soit $\epsilon>0$.
	Puisque $B_\epsilon(x)$ est un voisinage de $x$ il existe $N\in\N$ tel que $\forall n\supegal N$, $x_n\in B_\epsilon(x)$, c'est à dire $\exists N, \forall n\supegal N, d(x_n, x)\epsilon$.
}{
