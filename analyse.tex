...
\equivalence{Par double implication.}{
	...
	Ainsi $\complement O$ est un fermé ne contenant pas $x$ donc par $T_3$ il existe deux ouverts $U$, $V$ d'intersection vide tels que $x\in U$ et $\complement O\subset V$.
