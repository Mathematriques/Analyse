...
\begin{definition}
	La topologie cofinie est $\mathscr{T}=\{\vide\}\cup\ens{X\subset E}{\text{$\complement X$ fini}}$.
\end{definition}

\begin{definition}
	La topologie codénombrable est $\mathscr{T}=\{\vide\}\cup\ens{X\subset E}{\complement X\text{ dénombrable}}$.
\end{definition}

\begin{demonstration}
	Vérifions que la première est une topologie.
	La seconde s'en déduit en remplaçant fini par dénombrable.
	\begin{itemise}
...
\begin{proposition}
	La topologie classique sur $\R$ est $\mathscr{T}=\ens{]a, b[\subset\R}{a<b}$
\end{proposition}
...
Soit $E$ et $F$ deux espaces topologiques, $\mathcal{R}$ une relation d’équivalence sur $E$, $\pi\colon E\rightarrow E/\mathcal{R}$ la surjection canonique et $f\colon E/\mathcal{R}\rightarrow F$ une application.
...
\begin{definition}
	La topologie produit est la topologie initiale associées aux projections canoniques, c'est à dire la topologie la moins fine rendant les $\pi_i\colon F\rightarrow F_i$ continues.
\end{definition}
